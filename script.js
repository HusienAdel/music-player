...
function progressBarUpate(e){
    const width = e.srcElement.clientWidth;
   const clickX=e.offsetX;
    const {duration}=music;
    const parcent=(clickX / width)*duration;
    music.currentTime=parcent;
   
}


progressContainer.addEventListener('click', progressBarUpate);
...
>>>>>>> 0b792ba530344cc3ca20f7bc68c4043965cb7a1d
